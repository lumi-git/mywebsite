...
<div class="flex w-full">
    ...
    <div class="grid flex-grow card bg-base-300 rounded-box place-items-center p-5 m-10 w-1/2" >
        ...
        <div class = "card-body text-center text-xl  ">
            A key word for me is organization. The deference between a good and a bad project is the organization. The key is to be organized and to be able to adapt to the changes.
        </div>
    </div>
